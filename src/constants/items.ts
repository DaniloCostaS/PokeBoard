...
export const SHOP_ITEMS: ItemData[] = [
    ...
    { id: 'choice_scarf', name: 'Choice Scarf', desc: "Aumenta a velocidade em 20%, com o pokémon que estiver segurando esse item.", icon: 'choice_scarf.png', price: 999999, type: 'hold' },
    { id: 'rocky_helmet', name: 'Rocky Helmet', desc: "Causa 15% do dano recebido ao adversário, com o pokémon que estiver segurando esse item.", icon: 'rocky_helmet.png', price: 999999, type: 'hold' }
];